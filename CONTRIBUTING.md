# Contributing to Stacks · LuxeRetailStack
...
```bash
git clone https://github.com/smcatl/LuxeRetailStack.git
cd luxeretailstack
npm install
...
- `main` → production (auto-deploys to https://luxeretailstack.vercel.app)
...
Push to `main` → Vercel auto-deploys to https://luxeretailstack.vercel.app.

## Where to ask for help

- **Linear:** [Stacks · LuxeRetailStack](https://linear.app/skyyield/project/stacks-luxeretailstack-1e08f6aff886) — file an issue or comment on existing
